...
import net.mcreator.thedoomdragons.world.biome.SusBiome;
...
public class TheDoomDragonsModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, TheDoomDragonsMod.MODID);
				...
				if (dimensionType == dimensionTypeRegistry.getOrThrow(DimensionType.OVERWORLD_LOCATION)) {
					...
					if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
						...
						if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
							...
							surfaceRules.add(1,
									anySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, SUS.getId()),
											TheDoomDragonsModBlocks.AMOGUSDIRT.get().defaultBlockState(),
											TheDoomDragonsModBlocks.AMOGUSORE.get().defaultBlockState(),
											TheDoomDragonsModBlocks.AMOGUSORE.get().defaultBlockState()));
							surfaceRules.add(1,
